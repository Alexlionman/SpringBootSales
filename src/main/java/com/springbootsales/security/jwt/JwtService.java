...
public class JwtService {
    ...
    public String gerarToken(Usuario usuario){
        ...
        LocalDateTime momentoExpiracao = LocalDateTime.now().plusMinutes(expString);
        Instant instant = momentoExpiracao.atZone(ZoneId.systemDefault()).toInstant();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("O Token está valido: " + valido);
        System.out.println("Obtendo login: " + service.obterLoginUsuario(token));
    }
